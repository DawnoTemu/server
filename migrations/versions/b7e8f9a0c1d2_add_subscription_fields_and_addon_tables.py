...
def upgrade():
    ...
    op.create_index('ix_users_revenuecat_app_user_id', 'users', ['revenuecat_app_user_id'])

    # 2. Backfill trial_expires_at = created_at + 14 days for existing users
    op.execute(
    ...
    op.create_index('ix_consumed_addon_tx_receipt', 'consumed_addon_transactions', ['receipt_token'])
